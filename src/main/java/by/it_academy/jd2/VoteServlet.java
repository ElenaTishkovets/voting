...
@WebServlet(urlPatterns = "/voteTishkovets")
public class VoteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req,
        ...
        synchronized (data) {
            ...
            //Data data = new Data();
            Data.saveToContainer(data.getArtistsContainer(), artist);
            for (String genre : genres) {
                Data.saveToContainer(data.getGenreContainer(), genre);
            }
            data.getAboutContainer().add(about);
            this.destroy();
        }
    }
    ...
    private synchronized void writeTo(List<Map.Entry<String, Integer>> data, Writer writer) throws IOException {
        synchronized (data) {
    ...
    private synchronized List<String> getTop(Map<String, Integer> data) {
        synchronized (data) {
    ...
    private synchronized List<Map.Entry<String, Integer>> getTopWithScore(Map<String, Integer> data) {
        synchronized (data) {
            return data.entrySet()
                    .stream()
                    .sorted(Map.Entry.comparingByValue())
