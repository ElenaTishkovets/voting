...
import by.it_academy.jd2.service.api.dto.AllStatDtoBuilder;
...
public class StatService implements IStatService {
    ...
    private List<Map.Entry<String, Integer>> getTopWithScore(Map<String, Integer> data) {
        ...
        return data.entrySet()
                .stream()
                .sorted(Collections.reverseOrder(Map.Entry.comparingByValue()))//Collections.reverseOrder метод переворачивает коллекцию
                .collect(Collectors.toList());
    }
}
